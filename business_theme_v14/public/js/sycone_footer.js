    ...
    const footerHTML = `
        <div class="sycone-custom-footer">
            <div class="sycone-footer-content">
                ...
                //     <!-- Facebook -->
                //     <span class="sycone-social-icon" title="Facebook">
                ...
                //     <!-- Instagram -->
                //     <span class="sycone-social-icon" title="Instagram">
                //         <svg viewBox="0 0 24 24">
                ...
                //     <!-- YouTube -->
                //     <span class="sycone-social-icon" title="YouTube">
                //         <svg viewBox="0 0 24 24">
                ...
                //     <!-- X (Twitter) -->
                //     <span class="sycone-social-icon" title="X (Twitter)">
                //         <svg viewBox="0 0 24 24">
                ...
                //     <!-- LinkedIn -->
                //     <span class="sycone-social-icon" title="LinkedIn">
                //         <svg viewBox="0 0 24 24">
                ...
                <div class="sycone-copyright">
                    <span>© 2025 SYConE CPMC Pvt Ltd. All Rights Reserved | Privacy Policy | Terms & Conditions | Design: DNM</span>
                </div>
